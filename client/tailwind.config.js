  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'hero-gradient': 'linear-gradient(135deg, #1e1b4b 0%, #0f172a 50%, #0c1325 100%)',
        'card-gradient': 'linear-gradient(145deg, rgba(99,102,241,0.08) 0%, rgba(16,185,129,0.04) 100%)',
